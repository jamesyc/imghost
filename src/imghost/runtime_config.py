...
RUNTIME_CONFIG_SPECS: dict[str, RuntimeConfigSpec] = {
    ...
    "max_upload_bytes": RuntimeConfigSpec(
        "max_upload_bytes",
        "int",
        lambda: int(os.getenv("MAX_UPLOAD_BYTES", str(50 * 1024 * 1024))),
        "LOCK_MAX_UPLOAD_BYTES",
    ),
    "video_thumb_frames": RuntimeConfigSpec(
        "video_thumb_frames",
        "int",
        lambda: max(1, int(os.getenv("VIDEO_THUMB_FRAMES", "15"))),
        "LOCK_VIDEO_THUMB_FRAMES",
    ),
    "default_user_quota_bytes": RuntimeConfigSpec(
        "default_user_quota_bytes",
        "int",
        lambda: int(os.getenv("DEFAULT_USER_QUOTA_BYTES", str(2 * 1024 * 1024 * 1024))),
        "LOCK_DEFAULT_USER_QUOTA_BYTES",
    ),
    "server_quota_bytes": RuntimeConfigSpec(
        "server_quota_bytes",
        "int",
        lambda: int(os.getenv("SERVER_QUOTA_BYTES", "0")),
